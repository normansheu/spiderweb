...
def refine_registration(source, target, voxel_size, current_transformation, range_multiplier=1.0):
    """
    ICP Refinement using Point-to-Plane.
    """
    distance_threshold = voxel_size * range_multiplier
    # print(f"   :: ICP refinement (voxel={voxel_size:.3f}, threshold={distance_threshold:.3f})")
...
if __name__ == "__main__":
    ...
    file_list = [
        "video_processing/point_clouds/tangle016 255 2025-11-15 05-31-27 T0.55.pcd",
        "video_processing/point_clouds/tangle016r 255 2025-11-15 05-55-05 T0.55.pcd",
        "video_processing/point_clouds/tangle016u 255 2025-11-22 19-24-45 T0.55.pcd"
    ]
